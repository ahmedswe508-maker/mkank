  ...
  return (
    <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center px-4 sm:px-6 max-w-4xl mx-auto">
        ...
        {/* Title */}
        <h1 className="text-5xl sm:text-6xl md:text-7xl font-black text-white leading-tight mb-1">
          {t.hero.line1}
        </h1>
        <h2 className="text-4xl sm:text-5xl md:text-6xl font-black text-secondary leading-tight mb-8">
          {t.hero.line2}
        </h2>
